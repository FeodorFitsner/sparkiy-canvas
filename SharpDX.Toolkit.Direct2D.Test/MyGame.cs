...
using SharpDX.Toolkit.Direct2D.Test.Canvas;
...
namespace SharpDX.Toolkit.Direct2D.Test
{
    public class MyGame : Game
    {
        ...
        public Canvas.Canvas Canvas { get; private set; }
        ...
        public MyGame()
        {
            ...
            Services.AddService<IDirect2DService>(new Direct2DService(_graphicsDeviceManager));
  ...
  Canvas.PushObject(new CanvasTransform(Matrix3x2.Identity));
        ...
        protected override void Draw(GameTime time)
        {
            ...
            //    _texture2D.Width != GraphicsDevice.BackBuffer.Width)
            //{
            //    _texture2D.Dispose();
            ...
            //_spriteBatch.Begin();
            //_spriteBatch.Draw(_texture2D, Vector2.Zero, null, Color.Red, 0, Vector2.Zero, 0.25f,
