...
namespace SharpDX.Toolkit.Direct2D.Test.Canvas.Unused
{
    public interface IDeviceContext1
    {
        ...
        void DrawGeometryRealization(SharpDX.Direct2D1.GeometryRealization geometryRealization, SharpDX.Direct2D1.Brush brush);
        ...
        SharpDX.Direct2D1.Image Target { get; set; }
        ...
        SharpDX.Direct2D1.RenderingControls RenderingControls { get; set; }
        ...
        SharpDX.Direct2D1.PrimitiveBlend PrimitiveBlend { get; set; }
        ...
        SharpDX.Direct2D1.UnitMode UnitMode { get; set; }
        ...
        SharpDX.Matrix3x2 Transform { get; set; }
        ...
        SharpDX.Direct2D1.AntialiasMode AntialiasMode { get; set; }
        ...
        SharpDX.Direct2D1.TextAntialiasMode TextAntialiasMode { get; set; }
        ...
        SharpDX.DirectWrite.RenderingParams TextRenderingParams { get; set; }
        ...
        SharpDX.Direct2D1.PixelFormat PixelFormat { get; }
        ...
        SharpDX.Bool IsDxgiFormatSupported(SharpDX.DXGI.Format format);
        ...
        SharpDX.Bool IsBufferPrecisionSupported(SharpDX.Direct2D1.BufferPrecision bufferPrecision);
        ...
        SharpDX.RectangleF GetImageLocalBounds(SharpDX.Direct2D1.Image image);
        ...
        SharpDX.RectangleF GetImageWorldBounds(SharpDX.Direct2D1.Image image);
        ...
        SharpDX.RectangleF GetGlyphRunWorldBounds(SharpDX.Vector2 baselineOrigin, SharpDX.DirectWrite.GlyphRun glyphRun, SharpDX.Direct2D1.MeasuringMode measuringMode);
        ...
        void PushLayer(ref SharpDX.Direct2D1.LayerParameters1 layerParameters, SharpDX.Direct2D1.Layer layer);
        ...
        void InvalidateEffectInputRectangle(SharpDX.Direct2D1.Effect effect, int input, SharpDX.RectangleF inputRectangle);
        ...
        /// <unmanaged>void ID2D1DeviceContext::DrawImage([In] ID2D1Image* image,[In, Optional] const D2D_POINT_2F* targetOffset,[In, Optional] const D2D_RECT_F* imageRectangle,[In] D2D1_INTERPOLATION_MODE interpolationMode,[In] D2D1_COMPOSITE_MODE compositeMode)</unmanaged>	
        void DrawImage(SharpDX.Direct2D1.Effect effect, SharpDX.Vector2 targetOffset, SharpDX.Direct2D1.InterpolationMode interpolationMode = InterpolationMode.Linear, SharpDX.Direct2D1.CompositeMode compositeMode = CompositeMode.SourceOver);
        ...
        /// <param name="compositeMode">No documentation.</param>
        /// <unmanaged>void ID2D1DeviceContext::DrawImage([In] ID2D1Image* image,[In, Optional] const D2D_POINT_2F* targetOffset,[In, Optional] const D2D_RECT_F* imageRectangle,[In] D2D1_INTERPOLATION_MODE interpolationMode,[In] D2D1_COMPOSITE_MODE compositeMode)</unmanaged>
        void DrawImage(SharpDX.Direct2D1.Effect effect, SharpDX.Direct2D1.InterpolationMode interpolationMode = InterpolationMode.Linear, SharpDX.Direct2D1.CompositeMode compositeMode = CompositeMode.SourceOver);
        ...
        /// <param name="compositeMode">No documentation.</param>	
        /// <unmanaged>void ID2D1DeviceContext::DrawImage([In] ID2D1Image* image,[In, Optional] const D2D_POINT_2F* targetOffset,[In, Optional] const D2D_RECT_F* imageRectangle,[In] D2D1_INTERPOLATION_MODE interpolationMode,[In] D2D1_COMPOSITE_MODE compositeMode)</unmanaged>	
        void DrawImage(SharpDX.Direct2D1.Image image, SharpDX.Vector2 targetOffset, SharpDX.Direct2D1.InterpolationMode interpolationMode = InterpolationMode.Linear, SharpDX.Direct2D1.CompositeMode compositeMode = CompositeMode.SourceOver);
        ...
        /// <param name="compositeMode">No documentation.</param>
        /// <unmanaged>void ID2D1DeviceContext::DrawImage([In] ID2D1Image* image,[In, Optional] const D2D_POINT_2F* targetOffset,[In, Optional] const D2D_RECT_F* imageRectangle,[In] D2D1_INTERPOLATION_MODE interpolationMode,[In] D2D1_COMPOSITE_MODE compositeMode)</unmanaged>
        void DrawImage(SharpDX.Direct2D1.Image image, SharpDX.Direct2D1.InterpolationMode interpolationMode = InterpolationMode.Linear, SharpDX.Direct2D1.CompositeMode compositeMode = CompositeMode.SourceOver);
        ...
        /// <unmanaged>void ID2D1DeviceContext::DrawBitmap([In] ID2D1Bitmap* bitmap,[In, Optional] const D2D_RECT_F* destinationRectangle,[In] float opacity,[In] D2D1_INTERPOLATION_MODE interpolationMode,[In, Optional] const D2D_RECT_F* sourceRectangle,[In, Optional] const D2D_MATRIX_4X4_F* perspectiveTransform)</unmanaged>
        void DrawBitmap(SharpDX.Direct2D1.Bitmap bitmap, float opacity, SharpDX.Direct2D1.InterpolationMode interpolationMode);
        ...
        /// <unmanaged>void ID2D1DeviceContext::DrawBitmap([In] ID2D1Bitmap* bitmap,[In, Optional] const D2D_RECT_F* destinationRectangle,[In] float opacity,[In] D2D1_INTERPOLATION_MODE interpolationMode,[In, Optional] const D2D_RECT_F* sourceRectangle,[In, Optional] const D2D_MATRIX_4X4_F* perspectiveTransform)</unmanaged>
        void DrawBitmap(SharpDX.Direct2D1.Bitmap bitmap, float opacity, SharpDX.Direct2D1.InterpolationMode interpolationMode, SharpDX.Matrix perspectiveTransformRef);
        ...
        /// <param name="perspectiveTransformRef">The perspective transform ref.</param>
        /// <unmanaged>void ID2D1DeviceContext::DrawBitmap([In] ID2D1Bitmap* bitmap,[In, Optional] const D2D_RECT_F* destinationRectangle,[In] float opacity,[In] D2D1_INTERPOLATION_MODE interpolationMode,[In, Optional] const D2D_RECT_F* sourceRectangle,[In, Optional] const D2D_MATRIX_4X4_F* perspectiveTransform)</unmanaged>
        void DrawBitmap(SharpDX.Direct2D1.Bitmap bitmap, float opacity, SharpDX.Direct2D1.InterpolationMode interpolationMode, SharpDX.RectangleF sourceRectangle, SharpDX.Matrix perspectiveTransformRef);
        ...
        /// <unmanaged>void ID2D1DeviceContext::PushLayer([In] const D2D1_LAYER_PARAMETERS1* layerParameters,[In, Optional] ID2D1Layer* layer)</unmanaged>	
        void PushLayer(SharpDX.Direct2D1.LayerParameters1 layerParameters, SharpDX.Direct2D1.Layer layer);
        ...
        SharpDX.RectangleF[] GetEffectInvalidRectangles(SharpDX.Direct2D1.Effect effect);
        ...
        SharpDX.RectangleF[] GetEffectRequiredInputRectangles(SharpDX.Direct2D1.Effect renderEffect, SharpDX.Direct2D1.EffectInputDescription[] inputDescriptions);
        ...
        /// <returns></returns>
        /// <unmanaged>HRESULT ID2D1DeviceContext::GetEffectRequiredInputRectangles([In] ID2D1Effect* renderEffect,[In, Optional] const D2D_RECT_F* renderImageRectangle,[In, Buffer] const D2D1_EFFECT_INPUT_DESCRIPTION* inputDescriptions,[Out, Buffer] D2D_RECT_F* requiredInputRects,[In] unsigned int inputCount)</unmanaged>
        SharpDX.RectangleF[] GetEffectRequiredInputRectangles(SharpDX.Direct2D1.Effect renderEffect, SharpDX.RectangleF renderImageRectangle, SharpDX.Direct2D1.EffectInputDescription[] inputDescriptions);
        ...
        /// <unmanaged>void ID2D1DeviceContext::FillOpacityMask([In] ID2D1Bitmap* opacityMask,[In] ID2D1Brush* brush,[In, Optional] const D2D_RECT_F* destinationRectangle,[In, Optional] const D2D_RECT_F* sourceRectangle)</unmanaged>	
        void FillOpacityMask(SharpDX.Direct2D1.Bitmap opacityMask, SharpDX.Direct2D1.Brush brush);
        ...
        void DrawRoundedRectangle(ref SharpDX.Direct2D1.RoundedRectangle roundedRect, SharpDX.Direct2D1.Brush brush, float strokeWidth, SharpDX.Direct2D1.StrokeStyle strokeStyle);
        ...
        void FillRoundedRectangle(ref SharpDX.Direct2D1.RoundedRectangle roundedRect, SharpDX.Direct2D1.Brush brush);
        ...
        void DrawEllipse(SharpDX.Direct2D1.Ellipse ellipse, SharpDX.Direct2D1.Brush brush, float strokeWidth, SharpDX.Direct2D1.StrokeStyle strokeStyle);
        ...
        void FillEllipse(SharpDX.Direct2D1.Ellipse ellipse, SharpDX.Direct2D1.Brush brush);
        ...
        void FillOpacityMask(SharpDX.Direct2D1.Bitmap opacityMask, SharpDX.Direct2D1.Brush brush, SharpDX.Direct2D1.OpacityMaskContent content, SharpDX.RectangleF? destinationRectangle, SharpDX.RectangleF? sourceRectangle);
        ...
        void DrawBitmap(SharpDX.Direct2D1.Bitmap bitmap, SharpDX.RectangleF? destinationRectangle, float opacity, SharpDX.Direct2D1.BitmapInterpolationMode interpolationMode, SharpDX.RectangleF? sourceRectangle);
        ...
        /// <unmanaged>void ID2D1RenderTarget::DrawText([In, Buffer] const wchar_t* string,[In] unsigned int stringLength,[In] IDWriteTextFormat* textFormat,[In] const D2D_RECT_F* layoutRect,[In] ID2D1Brush* defaultForegroundBrush,[In] D2D1_DRAW_TEXT_OPTIONS options,[In] DWRITE_MEASURING_MODE measuringMode)</unmanaged>	
        /// <unmanaged-short>ID2D1RenderTarget::DrawText</unmanaged-short>	
        void DrawText(string text, int stringLength, SharpDX.DirectWrite.TextFormat textFormat, SharpDX.RectangleF layoutRect, SharpDX.Direct2D1.Brush defaultForegroundBrush, SharpDX.Direct2D1.DrawTextOptions options, SharpDX.Direct2D1.MeasuringMode measuringMode);
        ...
        void DrawTextLayout(SharpDX.Vector2 origin, SharpDX.DirectWrite.TextLayout textLayout, SharpDX.Direct2D1.Brush defaultForegroundBrush, SharpDX.Direct2D1.DrawTextOptions options);
        ...
        void DrawGlyphRun(SharpDX.Vector2 baselineOrigin, SharpDX.DirectWrite.GlyphRun glyphRun, SharpDX.Direct2D1.Brush foregroundBrush, SharpDX.Direct2D1.MeasuringMode measuringMode);
        ...
        void PushLayer(ref SharpDX.Direct2D1.LayerParameters layerParameters, SharpDX.Direct2D1.Layer layer);
        ...
        void SaveDrawingState(SharpDX.Direct2D1.DrawingStateBlock drawingStateBlock);
        ...
        void RestoreDrawingState(SharpDX.Direct2D1.DrawingStateBlock drawingStateBlock);
        ...
        void Clear(SharpDX.Color4? clearColor);
        ...
        SharpDX.Bool IsSupported(ref SharpDX.Direct2D1.RenderTargetProperties renderTargetProperties);
        ...
        /// </summary>	
        /// <remarks>	
        /// This method doesn't return an error code if it fails. To determine whether a drawing operation (such as {{DrawBitmap}}) failed, check the result returned by the <see cref="RenderTarget.EndDraw()"/> or <see cref="RenderTarget.Flush()"/> methods.  	
        /// </remarks>	
        /// <param name="bitmap">The bitmap to render. </param>
        ...
        /// <unmanaged>void ID2D1RenderTarget::DrawBitmap([In] ID2D1Bitmap* bitmap,[In, Optional] const D2D1_RECT_F* destinationRectangle,[None] float opacity,[None] D2D1_BITMAP_INTERPOLATION_MODE interpolationMode,[In, Optional] const D2D1_RECT_F* sourceRectangle)</unmanaged>
        void DrawBitmap(SharpDX.Direct2D1.Bitmap bitmap, SharpDX.RectangleF destinationRectangle, float opacity, SharpDX.Direct2D1.BitmapInterpolationMode interpolationMode);

        /// <summary>	
        /// Draws the specified bitmap after scaling it to the size of the specified rectangle. 	
        /// </summary>	
        /// <remarks>	
        /// This method doesn't return an error code if it fails. To determine whether a drawing operation (such as {{DrawBitmap}}) failed, check the result returned by the <see cref="RenderTarget.EndDraw()" /> or <see cref="M:SharpDX.Direct2D1.RenderTarget.Flush(System.Int64@,System.Int64@)" /> methods.  	
        /// </remarks>	
        /// <param name="bitmap">The bitmap to render. </param>
        /// <param name="opacity">A value between 0.0f and 1.0f, inclusive, that specifies an opacity value to apply to the bitmap; this value is multiplied against the alpha values of the bitmap's contents.  The default value is 1.0f. </param>
        /// <param name="interpolationMode">The interpolation mode to use if the bitmap is scaled or rotated by the drawing operation. The default value is <see cref="F:SharpDX.Direct2D1.BitmapInterpolationMode.Linear" />.  </param>
        ...
        /// <unmanaged>void ID2D1RenderTarget::DrawBitmap([In] ID2D1Bitmap* bitmap,[In, Optional] const D2D1_RECT_F* destinationRectangle,[None] float opacity,[None] D2D1_BITMAP_INTERPOLATION_MODE interpolationMode,[In, Optional] const D2D1_RECT_F* sourceRectangle)</unmanaged>
        void DrawBitmap(Bitmap bitmap, float opacity, BitmapInterpolationMode interpolationMode, RectangleF sourceRectangle);
        ...
        /// <unmanaged>void ID2D1RenderTarget::DrawTextA([In, Buffer] const wchar_t* string,[None] int stringLength,[In] IDWriteTextFormat* textFormat,[In] const D2D1_RECT_F* layoutRect,[In] ID2D1Brush* defaultForegroundBrush,[None] D2D1_DRAW_TEXT_OPTIONS options,[None] DWRITE_MEASURING_MODE measuringMode)</unmanaged>
        void DrawText(string text, TextFormat textFormat, RectangleF layoutRect, Brush defaultForegroundBrush, DrawTextOptions options);
        ...
        /// <unmanaged>void ID2D1RenderTarget::DrawTextA([In, Buffer] const wchar_t* string,[None] int stringLength,[In] IDWriteTextFormat* textFormat,[In] const D2D1_RECT_F* layoutRect,[In] ID2D1Brush* defaultForegroundBrush,[None] D2D1_DRAW_TEXT_OPTIONS options,[None] DWRITE_MEASURING_MODE measuringMode)</unmanaged>
        void DrawText(string text, TextFormat textFormat, RectangleF layoutRect, Brush defaultForegroundBrush, DrawTextOptions options, MeasuringMode measuringMode);
        ...
        /// When this method fails, it does not return an error code. To determine whether a drawing operation (such as FillGeometry) failed, check the result returned by the <see cref="RenderTarget.EndDraw()"/> or <see cref="RenderTarget.Flush()"/> method. 	
        /// </remarks>	
        ...
        void FillGeometry(SharpDX.Direct2D1.Geometry geometry, SharpDX.Direct2D1.Brush brush);
